...
async def ig_content_plan(a: dict, inventory: dict | None = None, rivals: str = "", covered: str = "",
    ...
    system = (
        ...
        "نوعِ محتوا (پست/ریل/کاروسل) در type، بهترین ساعتِ انتشار در time، یک «مدلِ مشخصِ موجود» از فهرستِ موجودی "
        "(نام/رفرنس) در brand، یک قلابِ کپشنِ فروش‌محور در hook، ۵ تا ۸ هشتگِ مرتبط در hashtags، و در stories "
        "«حداقل ۱۰ ایدهٔ استوریِ کوتاهِ آن روز» به‌صورتِ فهرستِ شماره‌دار که هرکدام یک مدلِ مشخصِ موجود (نام/رفرنس) را "
        "نشان می‌دهد و نوعش را بگوید (نظرسنجی/سؤال/بک‌استیج/مقایسه/قیمت‌محور/آموزشِ اصالت). هیچ روزی را ناقص نگذار.\n"
        ...
        "\"time\":\"...\",\"hook\":\"...\",\"hashtags\":\"...\",\"stories\":\"۱) …مدل/رفرنس… ۲) … (حداقل ۱۰ مورد)\"}],"
        "\"brand_plan\":[\"...\"]}"
    )
    user = (
