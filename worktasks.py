...
def _close_open_tasks_for_operator(uid) -> int:
    ...
    چون کارش (دفترچه/اینستا) با فروشِ ووکامرس قابلِ‌صحت‌سنجیِ خودکار نیست. برای پرسنلِ عادی (کارشناسِ فروش) اجرا نمی‌شود."""
...
async def _process_report(msg, user, text) -> None:
    ...
    اپراتور (اپراتور): ثبتِ گزارش همهٔ تسک‌های بازش را می‌بندد. پرسنلِ عادی (کارشناسِ فروش) صحت‌سنجی می‌شوند.
